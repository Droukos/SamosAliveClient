export default {
  ...
  history: {
    ...
    main:
      "Αυτή η σελίδα είναι μια βοήθεια για γρηγορότερη πλοήγηση και ανάθεση μεταξύ των υπάρχοντων συμβάντων και προβλημάτων. (Είναι ορατή μόνο σε συγκεκριμένους ρόλους)",
    occurrence: "Παρακάτω υπάρχει η λίστα με όλα τα ανεκπλήρωτα συμβάντα",
    problem:
      "Παρακάτω υπάρχει η λίστα με όλα τα προβλήματα απινιδωτών που εκκρεμούν",
    searchEvent: "Αναζήτηση συμβάντος",
    searchProblem: "Αναζήτηση προβλήματος",
    more: "Αναθεση"
  },
  problems: {
    form: "Ανάρτηση προβλήματος",
    problemTitle: "Τίτλος προβλήματος",
    problemContent: "Πρόβλημα απινιδοτή",
    submit: "Αποστολη"
  },
  news: {
    title: "Ανακοινώσεις",
    ...
    form: "Αναρτηση ανακοινωσης",
    formTitle: "Τίτλος ανακοίνωσης:",
    formContent: "Κείμενο ανακοινωσης:",
    submit: "Αναρτηση"
  },
  roles: {
    admins: {
